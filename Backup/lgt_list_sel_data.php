...
$fildsArray['state'] =   array('f_name'=>'state','f_type'=>'character varying');

$qWhere= DbBuildWhere($_POST,$fildsArray);

$Query="SELECT COUNT(*) AS count FROM (select g.* , k.name as kategor, st.name as state,
        c.name as calc_name, u1.name as user_name 
        ...
        left join lgi_grp_state_tbl as st on (st.id = g.id_state)
