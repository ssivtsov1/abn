...
try {
  ...
  if (isset($_POST['id_pack'])) {
    ...
    foreach($data_lines as $record) {
      ...
      $QE = "update clm_work_pack_data_tbl set indic = $indic, dt_indic = $dt_indic, 
          indic_real = $indic_real , id_person = $p_id_usr, dt = now(), act_num = '$act_num'
