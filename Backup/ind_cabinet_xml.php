...
print('<script type="text/javascript" src="ind_cabinet_xml.js?version='.$app_version.'"></script> ');
...
<script type="text/javascript">
    ...
    var lid_operation = 'null: ;100:Кабінет;0:Call-центр IVR;1:Call-центр опер.;2:Call-центр SMS.;10:XML;99:Оплата';
</script>
SCRYPT;
...
<body >
    ...
    <DIV id="pmain_center">    
        ...
        <div style="display: inline-block;">
        <form id="fLoad" method="post" action="ind_cabinet_xml_load_edit.php"> 
                <input type="hidden" name="oper" id="foper_xml" value="" />            
                <label> Завантажити показники з XML
                       <input id="fxml_file" type="file" size="70" name="xml_file"/>
                </label>    
                <button name="submitButton" type="submit" class ="btn" id="bt_load_xml" value="load" >Завантажити</button>
