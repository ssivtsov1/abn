...
$fildsArray =DbGetFieldsArray($Link,'lgi_calc_header_tbl');

$qWhere= DbBuildWhere($_POST,$fildsArray);

$Query="SELECT COUNT(*) AS count FROM lgi_calc_header_tbl $qWhere;";
...
$result = pg_query($Link,$SQL) or die("SQL Error: " .pg_last_error($Link) );
 ...
 while($row = pg_fetch_array($result)) {
      ...
      $data['rows'][$i]['cell'][] = $row['id_calc_type'];
