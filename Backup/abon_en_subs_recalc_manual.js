...
jQuery(function(){ 
  ...
  jQuery('#subs_table').jqGrid({
    url:'abon_en_subs_recalc_manual_data.php',
    editurl: 'abon_en_subs_recalc_manual_edit.php',
    datatype: 'json',
    mtype: 'POST',
    height:400,
    //width:800,
    ...
    {name:'id_manual', index:'id_manual', width:40, editable: false, align:'center',hidden:true},
    {name:'id_paccnt', index:'id_paccnt', width:40, editable: false, align:'center',hidden:true},

    {label:'Місяць',name:'mmgg_calc', index:'mmgg_calc', width:80, editable: true, 
                        align:'left',edittype:'text',formatter:'date'},

    {label:'Сума субсидії',name:'subs_current', index:'subs_current', width:100, editable: true, align:'right',hidden:false,
                            edittype:'text',formatter:'number'},           
    {label:"Обов'язковий платіж",name:'ob_pay', index:'ob_pay', width:100, editable: true, align:'right',hidden:false,
                            edittype:'text',formatter:'number'},           
    {label:"Сума факт.нарах.",name:'bill_sum', index:'bill_sum', width:100, editable: true, align:'right',hidden:false,
                            edittype:'text',formatter:'number'},           


    {label:"Походження",name:'source', index:'source', width:100, editable: false, align:'center', hidden:false},
    {label:"Враховується",name:'enabled', index:'enabled', width:50, editable: false, align:'center', hidden:false},
    ...
    viewrecords: true,
    gridview: true,
    caption: 'Субсидія та споживання в опалювальний період '+paccnt_info,
    //hiddengrid: false,
 ...
 //----------------------------------------------------------------  
jQuery("#subs_table").jqGrid('navButtonAdd','#subs_tablePager',{caption:"Редагувати",
...
jQuery("#subs_table").jqGrid('navButtonAdd','#subs_tablePager',{caption:"Видалити",
	onClickButton:function(){ 
      ...
      jQuery("#dialog-confirm").find("#dialog-text").html('Видалити ручне коригування данних?');
      ...
      $("#dialog-confirm").dialog({
			...
			buttons: {
				"Видалити": function() {
                                          ...
                                          fSubsEdit_ajaxForm[0].id_manual.value = $("#subs_table").jqGrid('getCell',edit_row_id,'id_manual');
...
var form_valid_options = { 
		...
		rules: {
			//dt_action: "required",
                        ob_pay:   {number:true},
                        subs_current:   {number:true},
                        bill_sum:{number:true}
		},
		messages: {
			//dt_action: "Вкажіть дату!",
                        ob_pay:     {number:"Повинно бути число!"},
                        subs_current:   {number:"Повинно бути число!"},
                        bill_sum:{number:"Повинно бути число!"}
