...
.snorm2 {font-style: italic; margin: 0px; padding: 0px; font-size: 8pt; font-family: "Courier New", Courier, monospace; line-height: 9px; }

.sinfo {margin-left: 2px; margin-right: 2px; margin-top: 0px; margin-bottom: 0px; padding: 0px; font-size: 8pt; font-family: "Arial", Helvetica, sans-serif; line-height: 11px; }
.sinfob {font-weight: bold; margin-left: 2px; margin-right: 2px; margin-top: 0px; margin-bottom: 0px; padding: 0px; font-size: 8pt; font-family: "Arial", Helvetica, sans-serif; line-height: 12px; }
.sinfo_h {text-align: center; margin-left: 0px; margin-right: 0px; margin-top: 0px; margin-bottom: 1px; padding: 0px; font-size: 10pt; font-family: "Times New Roman", Times, serif; line-height: 12px; }
span.cod {font-weight: bold; font-style: italic; font-size: 9pt; font-family: "Arial", Helvetica, sans-serif; }
...
.ssmallb {padding: 0px; font-family: "Times New Roman", Times, serif; font-weight: bold; line-height: 8px; font-size: 10px; margin: 0px;}
...
table.bill_left_table tr {line-height: 13px; }
table.bill_left_table td, table.bill_left_table th { border:1px solid black; }

table.bill_left_table td.no_border { border:0 none;}
table.bill_left_table tr.no_border { border:0px; }
...
table.bill_year_plan { border-collapse:collapse; margin:2px }
table.bill_year_plan tr {line-height: 13px; padding: 0px; }
table.bill_year_plan td, table.bill_year_plan th { border:1px solid black; padding: 0px;}

table.bill_info_table { border-collapse:collapse; margin-bottom:2px; }
table.bill_info_table td { border-top:1px solid black;}
table.bill_info_table td:nth-child(1n+2) { border-left:1px solid black;}
 ...
 echo <<<BILL_WINDOW_FORM
        ...
        <form id="fHeaderEdit" name="fHeaderEdit" method="post" action="bill_print.php" target="" class="no-print" >
          <div style='display:none;' > 
             ...
             <input type="text" name="mmgg" id="pmmgg" value="{$mmgg}" /> 
...
//    $total_value_tax =$saldo_e_tax+$avans_tax;
   ...
   // bill header !!!!
    ...
    <p class="sinfo_h">Як передати показники лічильника</p>
     ...
     <p class="sbold">Рахунок №$reg_num від {$reg_date}р. ЗА ЕЛЕКТРОЕНЕРГІЮ (<span class="cod">Код </span>{$index_accnt})</p> 
