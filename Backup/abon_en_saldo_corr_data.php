...
if ($sidx=='mmgg_corr')  $sidx=" mmgg $sord, mmgg_corr ";
...
$fildsArray =DbGetFieldsArray($Link,'acm_correct_paccnt');
...
$Query="SELECT COUNT(*) AS count FROM (
 select n.*,  u1.name as user_name 
from acm_correct_paccnt as n
