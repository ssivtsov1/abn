...
$selmode = 0; 
$nmp1 = "АЕ-Довідники - додаткові ознаки";

$cp1 = "Додаткові ознаки";
$gn1 = "dov_addparam";
...
print('<script type="text/javascript" src="dov_addparam.js"></script> ');

$r_edit = CheckLevel($Link,'довідник-додаткові ознаки',$session_user);
