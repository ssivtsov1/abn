...
$p_id_gr=sql_field_val('id_gr','int');
$p_id=sql_field_val('id','int');    

$QE="UPDATE eqi_switch_tbl
...
$QE="INSERT INTO eqi_switch_tbl(
            name, normative, voltage_nom, amperage_nom, voltage_max, 
            amperage_max, id_gr)
 values( $p_name, $p_normative, $p_voltage_nom, $p_amperage_nom, $p_voltage_max, $p_amperage_max, $p_id_gr );"; 
...
if ($oper=="del") {
 ...
 $p_id=sql_field_val('id','int');    
 $QE="Delete from eqi_switch_tbl where id= $p_id;"; 
