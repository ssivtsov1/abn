...
$nm1 = "АЕ-субсидія в опалювальний період абонента $paccnt_info";
...
print('<script type="text/javascript" src="abon_en_subs_recalc_manual.js?version='.$app_version.'"></script> ');
...
<DIV id="pmain_footer">
   ...
   <a href="javascript:void(0)" id="debug_ls3">clear debug window</a>
    ...
    <DIV id="pmain_content" style="margin:1px;padding:1px;">
        ...
        <form id="fSubsEdit" name="fSubsEdit" method="post" action="abon_en_subs_recalc_manual_edit.php" >
          <div class="pane"  >
            ...
            <input name="id_manual" type="hidden" id="fid_manual" value="" /> 
            <div class="pane"  >
                
            <p>            
                <label>Місяць
                    <input name="mmgg_calc" type="text" size="15" value="" id="fmmgg_calc"  data_old_value = "" readonly />
                </label>
                
            </p>
            <p>                                        
               <label>Сума субсидії
                    <input name="subs_current" type="text" id = "fsubs_current" size="10" value= "" data_old_value = ""  />
               </label> 

               <label>Обов'язковий платіж
                    <input name="ob_pay" type="text" id = "fob_pay" size="10" value= "" data_old_value = ""/>
               </label> 

               <label>Сума факт.нарахувань
                    <input name="bill_sum" type="text" id = "fbill_sum" size="10" value= "" data_old_value = ""/>
               </label> 
