...
if ($sidx=='reg_date')  $sidx="mmgg $sord ,reg_date $sord, mmgg_bill $sord, value";
...
$Query="SELECT COUNT(*) AS count FROM (
 select n.*, 
   case WHEN exists (select c.id_doc from acm_bill_tbl as c where c.id_paccnt = $pid_paccnt and c.id_corr_doc = n.id_doc) THEN 1 ELSE 0 END as is_corrected,
   u1.name as user_name 
   from acm_bill_tbl as n
