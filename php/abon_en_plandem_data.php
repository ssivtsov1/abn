...
$fildsArray =DbGetFieldsArray($Link,'clm_plandemand_tbl');
...
$qWhere=$qWhere." id_paccnt = $pid_eqp  and date_part('year', $p_mmgg::date) = date_part('year', mmgg::date ) ";


$Query="SELECT COUNT(*) AS count FROM 
(
 select n.* , u1.name as user_name from clm_plandemand_tbl as n
