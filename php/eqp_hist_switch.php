...
$fildsArray =DbGetFieldsArray($Link,'eqm_switch_h');
...
$Query="SELECT COUNT(*) AS count FROM eqm_switch_h $qWhere;";
...
$SQL = "select eq.id_key,eq.id_type_eqp, i.name as type_eqp,
       ...
       from eqm_switch_h as eq left join eqi_switch_tbl as i on (i.id = eq.id_type_eqp)
