...
*/
  ...
  jQuery('#headers_table').jqGrid({
    ...
    colModel :[ 
      ...
      {label:'id_position',name:'id_position', index:'id_position', width:40, editable: true, align:'right', hidden:true},
      ...
      {label:'addr',name:'addr', index:'addr', width:50, editable: true, align:'right',hidden:true,edittype:'text'},           
      {label:'Будинок',name:'addr_str', index:'addr_str', width:200, editable: true, align:'left',edittype:'text'},
      {label:'Прим',name:'note', index:'note', width:200, editable: true, align:'left',edittype:'text'},
    ...
    ondblClickRow: function(id){ 
        ...
        { 
            ...
            $("#fHeaderEdit").find("#fid_sector").attr('value','');
            $("#fHeaderEdit").find("#faddr").attr('value','');
            ...
            $("#fHeaderEdit").find("#btAddrSel").prop('disabled', true);
            $("#fHeaderEdit").find("#btAddrClear").prop('disabled', true);
            $("#fHeaderEdit").find("#btSectorSel").prop('disabled', true);
            $("#fHeaderEdit").find("#btSectorClear").prop('disabled', true);
            $("#fHeaderEdit").find("#fbook").attr('readonly', true);
...
//==============================================================================
  ...
  jQuery('#indic_table').jqGrid({
    url:'work_packs_indic_data.php',
    editurl: 'work_pack_indic_edit.php',
    //datatype: 'json',
    datatype: 'local',
    mtype: 'POST',
    height:200,
...
//    {name:'work_period', index:'work_period', width:80, editable: true, align:'left',edittype:'text', hidden:true},
    {label:'dt',name:'dt', index:'dt', width:100, editable: true, align:'left', formatter:'date', hidden:true,
            formatoptions:{srcformat:'Y-m-d H:i:s', newformat:'d.m.Y H:i'}},
...
var form_valid_options = { 
		...
		messages: {
			...
			dt_work: "Вкажіть дату"
                    //    id_position: "Вкажіть працівника!"
		}
};
...
jQuery("#headers_table").jqGrid('navButtonAdd','#headers_tablePager',{caption:"Нова",
    ...
    onClickButton:function(){ 
        ...
        $("#fHeaderEdit").find("#btAddrSel").prop('disabled', false);
        $("#fHeaderEdit").find("#btAddrClear").prop('disabled', false);
        $("#fHeaderEdit").find("#btSectorSel").prop('disabled', false);
        $("#fHeaderEdit").find("#btSectorClear").prop('disabled', false);
        $("#fHeaderEdit").find("#fbook").attr('readonly', false);
...
jQuery("#headers_table").jqGrid('navButtonAdd','#headers_tablePager',{caption:"Показники",
	...
	onClickButton:function(){ 
        ...
        { 
            ...
            $("#fHeaderEdit").attr('target',"work_input_win" );           
            $("#fHeaderEdit").attr('action',"work_packs_input.php" );               
    
            var ww = window.open("work_packs_input.php", "work_input_win", "toolbar=0,width=900,height=600");
            ...
            $("#fHeaderEdit").attr('action',"work_packs_edit.php" );               
        }
...
jQuery("#headers_table").jqGrid('navButtonAdd','#headers_tablePager',{caption:"Друк",
    ...
    onClickButton:function(){ 
        ...
        { 
            ...
            //else
            $("#fHeaderEdit").attr('action',"work_packs_print_res.php" );               
...
jQuery("#btAddrClear").click( function() { 
        jQuery("#faddr").attr('value','' );
        jQuery("#faddr_str").attr('value','' );    

});


$("#btAddrSel").click( function() { 
   ...
   jQuery("#btCntrlSel").click( function() { 
     ...
     createPersonGrid($("#fHeaderEdit").find("#fid_position").val());
     person_target_id=     $("#fHeaderEdit").find("#fid_position");
     person_target_name =  $("#fHeaderEdit").find("#fposition");
     person_target_prof = 0;
    
     jQuery("#grid_selperson").css({'left': $("#fHeaderEdit").find("#fposition").offset().left+1, 'top': $("#fHeaderEdit").find("#fposition").offset().top+20});
...
$("#fHeaderEdit").find('#fidk_work option').each(function(i, e)  
{
...
function SelectAddrExternal(code, name) {
   $("#fHeaderEdit").find(SelectAdrTarget).attr('value',code );
   $("#fHeaderEdit").find(SelectAdrStrTarget).attr('value',name );    
} 
