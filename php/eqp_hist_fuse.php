...
$fildsArray =DbGetFieldsArray($Link,'eqm_fuse_h');
...
$Query="SELECT COUNT(*) AS count FROM eqm_fuse_h $qWhere;";
...
$SQL = "select eq.id_key,eq.id_type_eqp, i.name as type_eqp,
       ...
       from eqm_fuse_h as eq left join eqi_fuse_tbl as i on (i.id = eq.id_type_eqp)
