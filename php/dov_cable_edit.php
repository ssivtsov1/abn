...
$p_cords=sql_field_val('cords','int');
...
$QE="UPDATE eqi_cable_tbl
   ...
   cords=$p_cords, dpo=$p_dpo, xo=$p_xo, ro=$p_ro, show_def=$p_show_def, s_nom=$p_s_nom
 WHERE id = $p_id;";
...
if ($oper=="del") {
 ...
 $p_id=sql_field_val('id','int');    
 $QE="Delete from eqi_cable_tbl where id= $p_id;"; 
